...
import '../../css/AuthPage.css'; // Make sure this CSS file includes the scrollbar styles
...
const SignupForm = ({ setView, setError, error }) => {
  ...
  return (
    <>
      ...
      <form onSubmit={handleSubmit(onSubmit)} noValidate className="signup-form-wrapper">

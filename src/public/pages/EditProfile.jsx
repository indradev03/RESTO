...
const EditProfile = () => {
  ...
  // Remove error state for UI error div — errors now handled by toast
  ...
  return (
    <div className="edit-profile-container">
      ...
      <form onSubmit={handleSubmit} className="edit-profile-form">
        <div className="form-columns">
          <div className="form-column left-column">
            ...
            <div className="form-field role-field">
              ...
              <input id="role" name="role" type="text" className="field-input" value={userData.role} readOnly />
            </div>
          </div>
        ...
        <button type="submit" className="edit-profile-submit-btn" disabled={imageUploading || formSubmitting}>
